...
<?php
	...
	if(isset($_POST['ac'])){
		...
		$username = "id20169404_root";
		$password = "#K]l8V#djeDV&%M=";
...
if(!isset($_SESSION['id'])){
	...
	echo '<blockquote>';
	echo '<a href="index.php"><img src="image/logo.png"></a>';
	echo '<form class="hf"><input class="hi" name="submitButton" value="Register"></form>';
	echo '<form class="hf"><input class="hi" name="submitButton" value="Login"></form>';
	echo '</blockquote>';
	echo '</header>';
}
...
echo '<blockquote>';
	echo "<table id='myTable' style='width:78%; float:left'>";
	echo "<tr>";
    while($row = $result->fetch_assoc()) {
	    echo "<td>";
	    echo "<table>";
    ...
    echo "Total: <b>RM".$total."</b><center><form  method='post'><input class='button' name='checkout' value='CHECKOUT'></form></center>";
    echo "</td></tr>";
	echo "</table>";
echo '</blockquote>';
...
<footer>
	<blockquote>
		<p>Developed By Rachana Amin - Assignment 1 | Bookstore</p>
	</blockquote>
</footer>
</html>